	...
	void startRequests(int numRequests, String requestDir) {
		...
		try {
			for (int i = 0; i < numRequests; i++) {
				Client client = new Client(Integer.valueOf(i + totalRequests));
...
// System.err.println("Manager update stats called: " + stats);
	 ...
	 * 
	 * @see
	 * com.softwareaggs.TestConsole.model.ClientManager#registerMonitorListener
	 * (com.softwareaggs.TestConsole.view.monitor.MonitorFeedListener)
	 */
