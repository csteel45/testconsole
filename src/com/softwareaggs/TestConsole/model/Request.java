 ...
 * @see com.softwareaggs.vs.ut.core.VSResponse
 */
...
/*
 * VSResponse result = harness.getResults(false); if (result == null) { throw
 * new Exception("Timeout"); } if (result.getEsbException() != null) { throw new
 * Exception("ESBException: " + result.getEsbException().toString()); }
 */			}
