...
// connectionFactory.createConnection();
			...
			Context ctx = null; // lookup.getInitialContext(props);
			System.err.println("NEED A CONTEXT, FIXME IN JMSConnection.java");
...
// System.err.println("Returning = " + num);
	...
	public static void writeRequest(RequestMessage request) throws Exception {
		java.lang.String fileName = REQUEST_DIR + System.currentTimeMillis();
