 ...
 * @(#)TestConsole.java
 * 
 * Copyright � 2013 Software AG GS, Inc. All Rights Reserved.
 * 
 * This software is the confidential and proprietary information of Software AG
 * GS , Inc. ("Confidential Information"). You shall not disclose such
 * Confidential Information and shall use it only in accordance with the terms
 * of the license agreement you entered into with Software AG GS.
 * 
 * Software AG GS MAKES NO REPRESENTATIONS OR WARRANTIES ABOUT THE SUITABILITY
 * OF THE SOFTWARE, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE
 * IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR
 * NON-INFRINGEMENT. Software AG GS SHALL NOT BE LIABLE FOR ANY DAMAGES SUFFERED
...
import com.softwareaggs.TestConsole.core.JMSConnection;
import com.softwareaggs.TestConsole.model.Dispatcher;
import com.softwareaggs.TestConsole.model.RequestStats;
import com.softwareaggs.TestConsole.model.RunInfo;
import com.softwareaggs.TestConsole.util.SplashScreen;
import com.softwareaggs.TestConsole.view.HelpDialog;
import com.softwareaggs.TestConsole.view.LogArea;
import com.softwareaggs.TestConsole.view.ResultsPanel;
import com.softwareaggs.TestConsole.view.TestConsoleMenuBar;
import com.softwareaggs.TestConsole.view.TestPanel;
import com.softwareaggs.TestConsole.view.monitor.MemoryMonitor;
import com.softwareaggs.TestConsole.view.monitor.MeterPanel;
 ...
 * @see com.softwareaggs.TestConsole.view.ResultsPanel
 */
...
// dispatcher.start();
	...
	public void init() {
		...
		this.setName("Software AG GS Test Console");
		this.setTitle("Software AG GS Test Console");
...
// System.out.println("Simultaneous = "+ testPanel.isSimultaneous());
						dispatcher.startRequests(numRequests,
								testPanel.getRequestDir(), "",
								testPanel.isSimultaneous());
					}
