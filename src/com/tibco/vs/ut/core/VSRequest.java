 ...
 */
public class VSRequest extends VerificationRequest {
	public static final String SOURCE_USER_ID = "UNIT TEST HARNESS";
	public static final String SOURCE_SYSTEM_ID = "VIS";
	...
	/**
	 * Construct a new VSRequest Object. Sets the SourceSystemID and the
